...
class MenuTable {
   ...
   /**
     ...
     * @param string $path Cadena con ruta de los índices del array multidimensional hasta llegar al page a insertar
     * @param array $menuTree array multidimensional con la estructura de un array de Zend\Navigation
